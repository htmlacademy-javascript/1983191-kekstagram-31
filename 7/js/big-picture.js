...
const renderModal = ({url, likes, comments, description}) => {
  ...
  // const commentsShown = picrureModal.querySelector('.social__comment-shown-count').textContent;
  // const commentsTotal = picrureModal.querySelector('.social__comment-total-count').textContent;
